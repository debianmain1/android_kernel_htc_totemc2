...
/* K2_C2 panel initial setting */
static char k2_f0_1_c2[] = {
    0xF0, 0x55, 0xAA, 0x52,
    0x08, 0x01}; /* DTYPE_DCS_LWRITE */
static char k2_b0_1_c2[] = {
    0xB0, 0xF0}; /* DTYPE_DCS_WRITE1 */
static char k2_b1_1_c2[] = {
    0xB1, 0x0F}; /* DTYPE_DCS_WRITE1 */
static char k2_b2_c2[] = {
    0xB2, 0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_b3_c2[] = {
    0xB3, 0x07}; /* DTYPE_DCS_WRITE1 */
static char k2_b6_1_c2[] = {
    0xB6, 0x14}; /* DTYPE_DCS_WRITE1 */
static char k2_b7_1_c2[] = {
    0xB7, 0x15}; /* DTYPE_DCS_WRITE1 */
static char k2_b8_1_c2[] = {
    0xB8, 0x24}; /* DTYPE_DCS_WRITE1 */
static char k2_b9_c2[] = {
    0xB9, 0x36}; /* DTYPE_DCS_WRITE1 */
static char k2_ba_c2[] = {
    0xBA, 0x24}; /* DTYPE_DCS_WRITE1 */
static char k2_bf_c2[] = {
    0xBF, 0x01}; /* DTYPE_DCS_WRITE1 */
static char k2_c3_c2[] = {
    0xC3, 0x11}; /* DTYPE_DCS_WRITE1 */
static char k2_c2_c2[] = {
    0xC2, 0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_c0_c2[] = {
    0xC0, 0x00, 0x00}; /* DTYPE_DCS_LWRITE */
static char k2_bc_1_c2[] = {
    0xBC, 0x00, 0x80, 0x00}; /* DTYPE_DCS_LWRITE */
static char k2_bd_c2[] = {
    0xBD, 0x00, 0x80, 0x00}; /* DTYPE_DCS_LWRITE */

static char k2_d1_c2[] = {
    0xD1, 0x00, 0x1E, 0x00, 0x35, 0x00, 0x4E, 0x00, 0x62, 0x00,
    0x71, 0x00, 0x90, 0x00, 0xB0, 0x00, 0xDE, 0x01, 0x05, 0x01,
    0x46, 0x01, 0x79, 0x01, 0xCA, 0x02, 0x0E, 0x02, 0x10, 0x02,
    0x4D, 0x02, 0x8F, 0x02, 0xB9, 0x02, 0xEF, 0x03, 0x12, 0x03,
    0x3E, 0x03, 0x5C, 0x03, 0x77, 0x03, 0x91, 0x03, 0x9E, 0x03,
    0xC3, 0x03, 0xF8};
static char k2_d2_c2[] = {
    0xD2, 0x00, 0x79, 0x00, 0x90, 0x00, 0x9A, 0x00, 0xA7, 0x00,
    0xB3, 0x00, 0xC9, 0x00, 0xE0, 0x01, 0x05, 0x01, 0x26, 0x01,
    0x5D, 0x01, 0x8B, 0x01, 0xD7, 0x02, 0x17, 0x02, 0x19, 0x02,
    0x52, 0x02, 0x93, 0x02, 0xBC, 0x02, 0xF2, 0x03, 0x14, 0x03,
    0x3F, 0x03, 0x5B, 0x03, 0x80, 0x03, 0x95, 0x03, 0xB0, 0x03,
    0xC2, 0x03, 0xF8};
static char k2_d3_c2[] = {
    0xD3, 0x00, 0x1E, 0x00, 0x37, 0x00, 0x49, 0x00, 0x5B, 0x00,
    0x6C, 0x00, 0x8B, 0x00, 0xA6, 0x00, 0xD3, 0x00, 0xF8, 0x01,
    0x36, 0x01, 0x69, 0x01, 0xBA, 0x01, 0xFD, 0x01, 0xFF, 0x02,
    0x3E, 0x02, 0x7E, 0x02, 0xA8, 0x02, 0xE6, 0x03, 0x0A, 0x03,
    0x41, 0x03, 0x63, 0x03, 0x8E, 0x03, 0xA6, 0x03, 0xCC, 0x03,
    0xD8, 0x03, 0xF9};
static char k2_d4_c2[] = {
    0xD4, 0x00, 0x3A, 0x00, 0x35, 0x00, 0x4E, 0x00, 0x62, 0x00,
    0x71, 0x00, 0x90, 0x00, 0xB0, 0x00, 0xDE, 0x01, 0x05, 0x01,
    0x46, 0x01, 0x79, 0x01, 0xCA, 0x02, 0x0E, 0x02, 0x10, 0x02,
    0x4D, 0x02, 0x8F, 0x02, 0xB9, 0x02, 0xEF, 0x03, 0x12, 0x03,
    0x3E, 0x03, 0x5C, 0x03, 0x77, 0x03, 0x91, 0x03, 0x9E, 0x03,
    0xC2, 0x03, 0xF8};
static char k2_d5_c2[] = {
    0xD5, 0x00, 0x95, 0x00, 0x90, 0x00, 0x9A, 0x00, 0xA7, 0x00,
    0xB3, 0x00, 0xC9, 0x00, 0xE0, 0x01, 0x05, 0x01, 0x26, 0x01,
    0x5D, 0x01, 0x8B, 0x01, 0xD7, 0x02, 0x17, 0x02, 0x19, 0x02,
    0x52, 0x02, 0x93, 0x02, 0xBC, 0x02, 0xF2, 0x03, 0x14, 0x03,
    0x3F, 0x03, 0x5B, 0x03, 0x80, 0x03, 0x95, 0x03, 0xB0, 0x03,
    0xC2, 0x03, 0xF8};
static char k2_d6_c2[] = {
    0xD6, 0x00, 0x3A, 0x00, 0x37, 0x00, 0x49, 0x00, 0x5B, 0x00,
    0x6C, 0x00, 0x8B, 0x00, 0xA6, 0x00, 0xD3, 0x00, 0xF8, 0x01,
    0x36, 0x01, 0x69, 0x01, 0xBA, 0x01, 0xFD, 0x01, 0xFF, 0x02,
    0x3E, 0x02, 0x7E, 0x02, 0xA8, 0x02, 0xE6, 0x03, 0x0A, 0x03,
    0x41, 0x03, 0x63, 0x03, 0x8E, 0x03, 0xA6, 0x03, 0xCC, 0x03,
...
static char k2_f0_2_c2[] = {
    0xF0, 0x55, 0xAA, 0x52,
    0x08, 0x00}; /* DTYPE_DCS_LWRITE */
static char k2_b6_2_c2[] = {
    0xB6, 0x03}; /* DTYPE_DCS_WRITE1 */
static char k2_b7_2_c2[] = {
    0xB7, 0x70, 0x70}; /* DTYPE_DCS_LWRITE */
static char k2_b8_2_c2[] = {
    0xB8, 0x01, 0x06, 0x06,
    0x06}; /* DTYPE_DCS_LWRITE */
static char k2_bc_2_c2[] = {
    0xBC, 0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_b0_2_c2[] = {
    0xB0, 0x00, 0x0A, 0x0E,
    0x09, 0x04}; /* DTYPE_DCS_LWRITE */
static char k2_b1_2_c2[] = {
    0xB1, 0x60, 0x00, 0x01}; /* DTYPE_DCS_LWRITE */
static char k2_b4_2_c2[] = {
    0xB4, 0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_f0_3_c2[] = {
	0xF0, 0x55, 0xAA, 0x52,
	0x00, 0x00}; /* DTYPE_DCS_LWRITE */
static char k2_ff_1_c2[] = {
    0xFF, 0xAA, 0x55, 0xA5,
    0x00}; /* DTYPE_DCS_LWRITE */


static struct dsi_cmd_desc k2_auo_display_on_cmds_c2[] = {
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_f0_1_c2), k2_f0_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b0_1_c2), k2_b0_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b1_1_c2), k2_b1_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b2_c2), k2_b2_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b3_c2), k2_b3_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b6_1_c2), k2_b6_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b7_1_c2), k2_b7_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b8_1_c2), k2_b8_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b9_c2), k2_b9_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_ba_c2), k2_ba_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_bf_c2), k2_bf_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_c3_c2), k2_c3_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_c2_c2), k2_c2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_c0_c2), k2_c0_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_bc_1_c2), k2_bc_1_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_bd_c2), k2_bd_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d1_c2), k2_d1_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d2_c2), k2_d2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d3_c2), k2_d3_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d4_c2), k2_d4_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d5_c2), k2_d5_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_d6_c2), k2_d6_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_f0_2_c2), k2_f0_2_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b6_2_c2), k2_b6_2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_b7_2_c2), k2_b7_2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_b8_2_c2), k2_b8_2_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_bc_2_c2), k2_bc_2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_b0_2_c2), k2_b0_2_c2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_b1_2_c2), k2_b1_2_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_b4_2_c2), k2_b4_2_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 1, sizeof(led_pwm2), led_pwm2},
	{DTYPE_DCS_LWRITE, 1, 0, 0, 0, sizeof(k2_ff_1_c2), k2_ff_1_c2},
	{DTYPE_DCS_WRITE1, 1, 0, 0, 0, sizeof(k2_f0_3_c2), k2_f0_3_c2},
	{DTYPE_PERIPHERAL_ON, 1, 0, 1, 120, sizeof(k2_peripheral_on), k2_peripheral_on},
};

//k2_jdi setting
static char k2_jdi_ff[] = {
    0xFF, 0xAA, 0x55, 0xA5,
    0x80}; /* DTYPE_GEN_LWRITE */
static char  k2_jdi_f7[] = {
    0xF7, 0x54}; /* DTYPE_GEN_WRITE2 */
static char k2_jdi_ff_1[] = {
    0xFF, 0xAA, 0x55, 0xA5,
...
static char k2_jdi_b7[] = {
    0xB7, 0x33, 0x73}; /* DTYPE_DCS_LWRITE */
...
static char k2_jdi_d6[] = {
    0xD6, 0x00, 0x04, 0x08,
    0x0C, 0x10, 0x14, 0x18,
    0x1C, 0x20, 0x24, 0x28,
    0x2C, 0x30, 0x34, 0x38,
    0x3C };/* DTYPE_DCS_LWRITE */
static char k2_jdi_e0[] = {
    0xE0, 0x01, 0x03};/* DTYPE_DCS_LWRITE */
...
#ifdef JDI_CABC_CMD
//CABC on
static char k2_jdi_51[] = {
    0x51, 0xFF}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_5e[] = {
    0x5E, 0x02}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_55[] = {
    0x55, 0x01}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_53[] = {
    0x53, 0x24}; /* DTYPE_DCS_WRITE1 */

//CABC off
static char k2_jdi_55_1[] = {
    0x55,0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_53_1[] = {
    0x53,0x00}; /* DTYPE_DCS_WRITE1 */
#endif
...
static struct dsi_cmd_desc  k2_jdi_display_on_cmds[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_ff), k2_jdi_ff},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(k2_jdi_f7), k2_jdi_f7},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_ff_1), k2_jdi_ff_1},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_f0), k2_jdi_f0},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_b1), k2_jdi_b1},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_b4), k2_jdi_b4},
    ...
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_d6), k2_jdi_d6},
...
#ifdef JDI_CABC_CMD
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_51), k2_jdi_51},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_5e), k2_jdi_5e},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_55), k2_jdi_55},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_53), k2_jdi_53},
#endif
...
#ifdef JDI_CABC_CMD
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_55_1), k2_jdi_55_1},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_53_1), k2_jdi_53_1},
#endif
...
static char k2_jdi_ff_t02[] = {
    0xFF, 0xAA, 0x55, 0xA5,
    0x80}; /* DTYPE_GEN_LWRITE */
static char k2_jdi_f7_t02[] = {
    0xF7, 0x54}; /* DTYPE_GEN_WRITE2 */
static char k2_jdi_ff_1_t02[] = {
    0xFF, 0xAA, 0x55, 0xA5,
    0x00}; /* DTYPE_GEN_LWRITE */
static char k2_jdi_f0_t02[] = {
    0xF0, 0x55, 0xAA, 0x52,
    0x08, 0x01}; /* DTYPE_DCS_LWRITE */
//Gamma Table
static char k2_jdi_d1_t02[] = {
    0xD1, 0x00, 0x5F, 0x00,
    0x6D, 0x00, 0x89, 0x00,
    0xA1, 0x00, 0xB7, 0x00,
    0xD9, 0x00, 0xF4, 0x01,
...
static char k2_jdi_f0_1_t02[] = {
	0xF0, 0x55, 0xAA, 0x52,
	0x00, 0x01}; /* DTYPE_DCS_LWRITE */

static char k2_jdi_f0_2_t02[] = {
	0xF0, 0x55, 0xAA, 0x52,
	0x00, 0x00}; /* DTYPE_DCS_LWRITE */

#ifdef JDI_CABC_CMD
//CABC on
static char k2_jdi_51_t02[] = {
    0x51, 0xFF}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_5e_t02[] = {
    0x5E, 0x02}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_55_t02[] = {
    0x55, 0x01}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_53_t02[] = {
    0x53, 0x24}; /* DTYPE_DCS_WRITE1 */

//CABC off
static char k2_jdi_55_1_t02[] = {
    0x55,0x00}; /* DTYPE_DCS_WRITE1 */
static char k2_jdi_53_1_t02[] = {
    0x53,0x00}; /* DTYPE_DCS_WRITE1 */
#endif

static char k2_jdi_pwm2_t02[] = {0x53, 0x24}; /* DTYPE_GEN_WRITE2 */
static char k2_jdi_peripheral_on_t02[] = {0x00, 0x00}; /* DTYPE_PERIPHERAL_ON */
static char k2_jdi_peripheral_off_t02[] = {0x00, 0x00};

static struct dsi_cmd_desc k2_jdi_display_off_cmds_t02[] = {
#ifdef JDI_CABC_CMD
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_55_1_t02), k2_jdi_55_1_t02},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_53_1_t02), k2_jdi_53_1_t02},
#endif
    {DTYPE_PERIPHERAL_OFF, 1, 0, 1, 70, sizeof(k2_jdi_peripheral_off_t02), k2_jdi_peripheral_off_t02},
};

static struct dsi_cmd_desc  k2_jdi_display_on_cmds_t02[] = {
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_ff_t02), k2_jdi_ff_t02},
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0, sizeof(k2_jdi_f7_t02), k2_jdi_f7_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_ff_1_t02), k2_jdi_ff_1_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0, sizeof(k2_jdi_f0_t02), k2_jdi_f0_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d1_t02), k2_jdi_d1_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d2_t02), k2_jdi_d2_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d3_t02), k2_jdi_d3_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d4_t02), k2_jdi_d4_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d5_t02), k2_jdi_d5_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_d6_t02), k2_jdi_d6_t02},
#ifdef JDI_CABC_CMD
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_51_t02), k2_jdi_51_t02},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_5e_t02), k2_jdi_5e_t02},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_55_t02), k2_jdi_55_t02},
    {DTYPE_GEN_WRITE1, 1, 0, 0, 0, sizeof(k2_jdi_53_t02), k2_jdi_53_t02},
#endif
    {DTYPE_GEN_WRITE2, 1, 0, 0, 0,sizeof(k2_jdi_pwm2_t02), k2_jdi_pwm2_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_f0_2_t02), k2_jdi_f0_1_t02},
    {DTYPE_GEN_LWRITE, 1, 0, 0, 0,sizeof(k2_jdi_f0_2_t02), k2_jdi_f0_2_t02},
    {DTYPE_PERIPHERAL_ON, 1, 0, 1, 120,sizeof(k2_jdi_peripheral_on_t02), k2_jdi_peripheral_on_t02},
};
...
static void mipi_novatek_panel_type_detect(struct mipi_panel_info *mipi)
{
	if (panel_type == PANEL_ID_K2_WL_AUO) {
		...
		if (mipi->mode == DSI_VIDEO_MODE) {
			novatek_display_on_cmds = k2_jdi_display_on_cmds_t02;
			novatek_display_on_cmds_size = ARRAY_SIZE(k2_jdi_display_on_cmds_t02);
			novatek_display_off_cmds = k2_jdi_display_off_cmds_t02;
			novatek_display_off_cmds_size = ARRAY_SIZE(k2_jdi_display_off_cmds_t02);
		}
        }
}
