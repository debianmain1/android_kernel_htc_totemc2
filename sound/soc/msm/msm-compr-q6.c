...
//HTC_AUD+
static unsigned int compr_pcm_number;
module_param(compr_pcm_number, uint, 0555);
MODULE_PARM_DESC(compr_pcm_number, "default pcm number for compr module.");
		...
		uint32_t token, uint32_t *payload, void *priv)
{
	...
	int i = 0;
//HTC_AUD+
	wake_lock_timeout(&compr_lpa_wakelock, 1 * HZ);
//HTC_AUD-
...
static int msm_compr_prepare(struct snd_pcm_substream *substream)
{
	int ret = 0;
	/* HTC_AUD ++ */
	compressed_set_volume(compressed_audio.volume);
	/* HTC_AUD -- */
