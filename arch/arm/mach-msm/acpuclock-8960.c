...
/* 	{ 1, {  1458000, HFPLL, 1, 0, 0x36 }, L2(16), 1375000 },
 	{ 1, {  1512000, HFPLL, 1, 0, 0x38 }, L2(16), 1375000 },*/
	{ 0, { 0 } }
};
...
static void __init select_freq_plan(void)
{
	...
	if (krait_needs_vmin()) {
		pr_info("Applying Vmin 1.15v fix for Krait Errata 26\n");
